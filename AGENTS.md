...
This file indexes all skills for the ArcGIS Maps SDK for JavaScript. Skills are organized by SDK version. Use this to find the right skill for a task, combine skills for complex workflows, and make quick architectural decisions.

## Version 5.0 (35 skills)
...
## Version 4.34 (31 skills)

Legacy version. Uses AMD or ES modules, `@arcgis/core`, and supports both Map Components and classic `new MapView()` patterns.
...
### AI-powered map chat (5.0 only)
`arcgis-ai-components` + `arcgis-core-maps` + `arcgis-layers`

### Embed a quick map (5.0 only)
`arcgis-embeddable-maps`

### Data dashboard with charts (5.0 only)
...
### Version Selection (4.34 vs 5.0)

| Scenario | Recommended Version |
|----------|-------------------|
| New project, greenfield | 5.0 |
| Need AI components, charts, embeds | 5.0 (these are 5.0-only) |
| Maintaining existing 4.x codebase | 4.34 |
| Need AMD module support | 4.34 |
| Want latest ES modules only | 5.0 |
