...
3. **Do you need to customize widget behavior with callbacks?**
   - Yes --> Core API widget gives more control
   - No --> Component is simpler

**Default:** Always prefer Map Components. Esri has transitioned to web components as the primary approach.
